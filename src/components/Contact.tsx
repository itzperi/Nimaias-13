          ...
          <div className="text-white space-y-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/showcase/nimais/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-raastas-light">
                  <img src="/lovable-uploads/512d52e2-ef42-457a-8cb6-97a2f00e4bd8.png" alt="LinkedIn" className="w-8 h-8" />
                </a>
                <a href="https://www.instagram.com/nimaisi?igsh=a2hyNm5heDlrMm8y" target="_blank" rel="noopener noreferrer" className="text-white hover:text-raastas-light">
                  <img src="/lovable-uploads/e3da94cd-b824-45e7-ab15-088835ea68ef.png" alt="Instagram" className="w-8 h-8" />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61571702312928&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="text-white hover:text-raastas-light">
                  <img src="/lovable-uploads/c0490498-6065-453f-a000-fad9b611cb92.png" alt="Facebook" className="w-8 h-8" />
                </a>
                <a href="https://x.com/Nimaisx?t=wDMfIqXFzycHVSPcP-j4ZQ&s=09" target="_blank" rel="noopener noreferrer" className="text-white hover:text-raastas-light">
                  <img src="/lovable-uploads/7210acb8-d873-45a6-a2a1-1d6ec09ded9b.png" alt="Twitter" className="w-8 h-8" />
                </a>
                <a href="https://www.youtube.com/channel/UCYMtEiPx9p5R90KBJ7Wz3og" target="_blank" rel="noopener noreferrer" className="text-white hover:text-raastas-light">
