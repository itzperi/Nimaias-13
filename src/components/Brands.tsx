...
const Brands = () => {
  ...
  return (
    <div className="py-12 bg-[#F3F0FF] overflow-hidden">
      ...
      >
        <h2 className="text-2xl md:text-2xl font-bold text-center mb-8 max-w-2xl mx-auto">
...
neuromarketing with measurable outcomes.
        ...
        >
          <motion.div 
            className="flex space-x-20 items-center" // Increased gap between brands
            animate={{ x: [0, -1500] }} // Increased animation width for more brands
            transition={{
              x: {
                repeat: Infinity,
                repeatType: "loop",
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className="w-32 md:w-40 h-24 flex-shrink-0" // Increased size
                  >
                    <img
                      src={brand.src}
                      alt={brand.alt}
