  ...
  const services = [
    {
      ...
      description: "Adapt your content to fit conversational search queries, making it easier to rank in voice search results",
    ...
    },
    {
      ...
      description: "Provide natural, question-based answers that match the way people use voice search",
      image: "/lovable-uploads/9f659de8-659a-495c-920a-e9de0d778968.png",
      link: "/services/b2b-marketing/greater-credibility"
    },
    {
      title: "Stimulate Engagement",
      description: "Offer quick, accurate results for voice-enabled searches to keep users engaged. Take advantage of the growing voice search trend. Optimize your content today.",
      image: "/lovable-uploads/9f659de8-659a-495c-920a-e9de0d778968.png",
